...
echo"
<li class='active' id='select1' onclick='select1()'><a href='#'>จำนวนรถที่เช้าใช้บริการ Drive Thru<br>ต่อสัปดาห์</a></li>
...
$date_7=date("Y-m-d",strtotime("$day -6 day"));
//echo $date_7;
//echo $day;
					...
					"valueAxes": [
						{
							"id": "ValueAxis-1",
							"stackType": "regular",
							"title": "จำนวนรถที่เข้าใช้บริการ Drive Thru ย้อนหลัง 7 วัน"
						}
					],
					"allLabels": [],
					"balloon": {},
					...
					"titles": [
						{
							"id": "Title-1",
							"size": 15,
							"text": "จำนวนรถที่เข้าใช้บริการ Drive Thru  ย้อนหลัง 7 วัน"
						}
					],
					"dataProvider": [
						<?php echo $all_w;?>
...
<?php
echo "<p class='right'>จำนวนรถที่เข้าใช้งาน drive thru ตั้งแต่วันที่ $date_7 ถึง $day ทั้งหมด $all_sum_w คัน</p>";
echo "<p class='right'>จำนวนรถที่เข้าใช้งาน drive thru เฉลี่ยตั้งแต่วันที่ $date_7 ถึง $day เท่ากับ ".number_format($avg_w)." คัน</p>";
...
<?php require('js/function_drive_thrus.php')?>
</body>
</html>