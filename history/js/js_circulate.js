...
function select3(){
    ...
    function select_month(str){
		...
		window.location="circulate.php?month="+str.value+"&year="+<?php echo $y?>+"&day=<?php echo $day?>"+"&menu="+menu;
                }
    function select_year(year){ 
	menu=document.getElementById("cal").value;          
		window.location="circulate.php?year="+year.value+"&month="+<?php echo $m?>+"&day=<?php echo $day?>"+"&menu="+menu;
                }
	function select_date(date){
		menu=document.getElementById("cal").value;           
		window.location="circulate.php?day="+date.value+"&month="+<?php echo $m?>+"&year="+<?php echo $y?>+"&menu="+menu;
                }
