...
function select3(){
    ...
    function select_month(str){
		...
		window.location="drive_thru_test.php?month="+str.value+"&year="+<?php echo $y?>+"&day=<?php echo $day?>"+"&menu="+menu+"&begin_date=<?php echo $begin_date?>";
                }
    function select_year(year){ 
	menu=document.getElementById("cal").value;          
		window.location="drive_thru_test.php?year="+year.value+"&month="+<?php echo $m?>+"&day=<?php echo $day?>"+"&menu="+menu+"&begin_date=<?php echo $begin_date?>";
                }
	function select_date(date){
		menu=document.getElementById("cal").value;           
		window.location="drive_thru_test.php?day="+date.value+"&month="+<?php echo $m?>+"&year="+<?php echo $y?>+"&menu="+menu+"&begin_date=<?php echo $begin_date?>";
                }
	function select_begin_date(begin_date){
		menu=document.getElementById("cal").value;          
		window.location="drive_thru_test.php?begin_date="+begin_date.value+"&month="+<?php echo $m?>+"&year="+<?php echo $y?>+"&day=<?php echo $day?>"+"&menu="+menu;
                }
