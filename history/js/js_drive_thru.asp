...
function line1(li){
	...
	document.getElementById("line_chartdiv").style.display = "none"
	document.getElementById("chartdiv1").style.display = "block";
	document.getElementById("line_chartdiv1").style.display = "none"
	document.getElementById("chartdiv2").style.display = "block";
	document.getElementById("line_chartdiv2").style.display = "none";
	}else if(li.value==2){
	document.getElementById("chartdiv").style.display = "none";
	document.getElementById("line_chartdiv").style.display = "block";
	document.getElementById("chartdiv1").style.display = "none";
	document.getElementById("line_chartdiv1").style.display = "block";
	document.getElementById("chartdiv2").style.display = "none";
	document.getElementById("line_chartdiv2").style.display = "block";}
	}
function check(){
